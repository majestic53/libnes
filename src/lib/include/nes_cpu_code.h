...
namespace NES {
	...
	#define CPU_CODE_ADC_ABSOLUTE_CYCLES 4
	#define CPU_CODE_ADC_ABSOLUTE_X_CYCLES 4
	#define CPU_CODE_ADC_ABSOLUTE_Y_CYCLES 4
	#define CPU_CODE_ADC_IMMEDIATE_CYCLES 2
	#define CPU_CODE_ADC_INDIRECT_X_CYCLES 6
	#define CPU_CODE_ADC_INDIRECT_Y_CYCLES 5
	#define CPU_CODE_ADC_ZERO_PAGE_CYCLES 3
	#define CPU_CODE_ADC_ZERO_PAGE_X_CYCLES 4
